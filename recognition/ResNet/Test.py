...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        test_recall = recall_score(labels_test, outputs_test, average="macro")
        test_precision = precision_score(labels_test, outputs_test, average="macro")

        print("Test F1 %.3f, recall %.3f, precision %.3f" % (test_f1, test_recall, test_precision))
