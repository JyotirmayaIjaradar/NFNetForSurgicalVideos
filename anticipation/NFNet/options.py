...
parser.add_argument('--data_folder', type=str, default='/local_home/bodenstse/cholec80_1fps/frames/')
parser.add_argument('--annotation_folder', type=str, default='/home/ljaradajy/Downloads/tool_annotations/')
parser.add_argument('--output_folder', type=str, default='/mnt/g27prist/TCO/TCO-Studenten/jyotirmaya/nfnet-ant/output/experiments/')
...
parser.add_argument('--model_folder', type=str, default='../output/experiments/20200821-1203_horizon5_anticipationTest/models/')
